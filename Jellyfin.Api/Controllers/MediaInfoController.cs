...
namespace Jellyfin.Api.Controllers
{
    ...
    public class MediaInfoController : BaseJellyfinApiController
    {
        ...
        public ActionResult GetBitrateTestBytes([FromQuery][Range(1, 100_000_000, ErrorMessage = "The requested size must be greater than or equal to {1} and less than or equal to {2}")] int size = 102401)
        {
